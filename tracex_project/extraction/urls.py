...
urlpatterns = [
    ...
    path("extraction/", views.JourneyInputSelectView.as_view(), name="choose_input_method"),
    path("extraction/upload/", views.JourneyInputView.as_view(), name="journey_upload"),
    path("extraction/select/", views.JourneySelectView.as_view(), name="journey_select"),
