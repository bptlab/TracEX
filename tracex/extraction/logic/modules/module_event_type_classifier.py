...
class EventTypeClassifier(Module):
    ...
    def execute(self, _input, patient_journey=None):
        self.result = self.add_event_types(_input)

    def add_event_types(self, activity_labels):
        ...
        activity_labels_with_event_types = self.add_ending_commas(activity_labels_with_event_types)
        with open(
    ...
    @staticmethod
    def add_ending_commas(activity_labels):
